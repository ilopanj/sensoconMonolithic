...
describe('Service Tests', () => {
    describe('NotificationGroup Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(NotificationGroupService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/notification-groups';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a NotificationGroup', () => {
                service.create(new NotificationGroup(null)).subscribe(received => {
            ...
            it('should update a NotificationGroup', () => {
                service.update(new NotificationGroup(123)).subscribe(received => {
            ...
            it('should return a NotificationGroup', () => {
            ...
            it('should return a list of NotificationGroup', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new NotificationGroup(123)]);
            });
